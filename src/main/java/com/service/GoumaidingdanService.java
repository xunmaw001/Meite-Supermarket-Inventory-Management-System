...
public interface GoumaidingdanService extends IService<GoumaidingdanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<GoumaidingdanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<GoumaidingdanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<GoumaidingdanEntity> wrapper);

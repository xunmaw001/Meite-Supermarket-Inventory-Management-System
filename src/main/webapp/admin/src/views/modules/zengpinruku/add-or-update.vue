	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="赠品数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="赠品数量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="赠品数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="赠品数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="select" v-if="type!='info'"  label="赠品商" prop="gongyingshang">
					<el-select :disabled="ro.gongyingshang" v-model="ruleForm.gongyingshang" placeholder="请选择赠品商" >
						<el-option
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="赠品商" prop="gongyingshang">
					<el-input v-model="ruleForm.gongyingshang"
						placeholder="赠品商" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="赠品备注" prop="zengpinbeizhu">
					<el-input v-model="ruleForm.zengpinbeizhu" placeholder="赠品备注" clearable  :readonly="ro.zengpinbeizhu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="赠品备注" prop="zengpinbeizhu">
					<el-input v-model="ruleForm.zengpinbeizhu" placeholder="赠品备注" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="入库日期" prop="rukuriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.rukuriqi" label="入库日期" prop="rukuriqi">
	...
	data() {
		...
		return {
			...
			rules: {
				...
				gongyingshang: [
					{ required: true, message: '赠品商不能为空', trigger: 'blur' },
				],
				zengpinbeizhu: [
				],
				rukuriqi: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='zengpinbeizhu'){
							this.ruleForm.zengpinbeizhu = obj[o];
							this.ro.zengpinbeizhu = true;
							continue;
						}
						if(o=='rukuriqi'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `zengpinruku/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.zengpinrukuCrossAddOrUpdateFlag = false;
						 this.parent.search();

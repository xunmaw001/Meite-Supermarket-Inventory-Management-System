	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="销售数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="销售数量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="销售数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" placeholder="销售数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="销售单价" prop="xiaoshoudanjia">
					<el-input v-model="ruleForm.xiaoshoudanjia" placeholder="销售单价" clearable  :readonly="ro.xiaoshoudanjia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="销售单价" prop="xiaoshoudanjia">
					<el-input v-model="ruleForm.xiaoshoudanjia" placeholder="销售单价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="销售金额" prop="xiaoshoujine">
					<el-input v-model="xiaoshoujine" placeholder="销售金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.xiaoshoujine" label="销售金额" prop="xiaoshoujine">
					<el-input v-model="ruleForm.xiaoshoujine" placeholder="销售金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="客户" prop="kehu">
					<el-input v-model="ruleForm.kehu" placeholder="客户" clearable  :readonly="ro.kehu"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="客户" prop="kehu">
					<el-input v-model="ruleForm.kehu" placeholder="客户" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="销售日期" prop="xiaoshouriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.xiaoshouriqi" label="销售日期" prop="xiaoshouriqi">
					<el-input v-model="ruleForm.xiaoshouriqi" placeholder="销售日期" readonly></el-input>
				</el-form-item>
			</template>
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xiaoshouxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xiaoshouxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();

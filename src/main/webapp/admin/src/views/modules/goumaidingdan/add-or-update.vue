	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="金额" prop="jine">
					<el-input v-model="jine" placeholder="金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jine" label="金额" prop="jine">
...
export default {
	...
	computed: {
		...
		jine:{
			get: function () {
				return 1*this.ruleForm.shoujia*this.ruleForm.shuliang*this.ruleForm.shangpinzhekou
			}
		},

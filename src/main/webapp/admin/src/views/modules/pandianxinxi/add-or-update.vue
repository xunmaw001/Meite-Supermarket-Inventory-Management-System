	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="盘点数量" prop="pandianshuliang">
					<el-input v-model="ruleForm.pandianshuliang" placeholder="盘点数量" clearable  :readonly="ro.pandianshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="盘点数量" prop="pandianshuliang">
					<el-input v-model="ruleForm.pandianshuliang" placeholder="盘点数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="盘点日期" prop="pandianriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.pandianriqi" label="盘点日期" prop="pandianriqi">
					<el-input v-model="ruleForm.pandianriqi" placeholder="盘点日期" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="盘点备注" prop="pandianbeizhu">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="盘点备注"
					  v-model="ruleForm.pandianbeizhu" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.pandianbeizhu" label="盘点备注" prop="pandianbeizhu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.pandianbeizhu}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			rules: {
				...
				pandianbeizhu: [
					{ required: true, message: '盘点备注不能为空', trigger: 'blur' },
				],
				pandianriqi: [
				],
			}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `pandianxinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.pandianxinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();

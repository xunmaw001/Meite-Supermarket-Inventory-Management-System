	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="售价" prop="shoujia">
					<el-input v-model="ruleForm.shoujia" placeholder="售价" clearable  :readonly="ro.shoujia"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="售价" prop="shoujia">
					<el-input v-model="ruleForm.shoujia" placeholder="售价" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="商品折扣" prop="shangpinzhekou">
					<el-input v-model="ruleForm.shangpinzhekou" placeholder="商品折扣" clearable  :readonly="ro.shangpinzhekou"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="商品折扣" prop="shangpinzhekou">
					<el-input v-model="ruleForm.shangpinzhekou" placeholder="商品折扣" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="商品位置" prop="shangpinweizhi">
					<el-input v-model="ruleForm.shangpinweizhi" placeholder="商品位置" clearable  :readonly="ro.shangpinweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="商品位置" prop="shangpinweizhi">
					<el-input v-model="ruleForm.shangpinweizhi" placeholder="商品位置" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="商品备注" prop="shangpinbeizhu">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="商品备注"
					  v-model="ruleForm.shangpinbeizhu" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.shangpinbeizhu" label="商品备注" prop="shangpinbeizhu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.shangpinbeizhu}}</span>
				</el-form-item>
	...
	data() {
		...
		return {
			...
			ro:{
				...
				shoujia : false,
				shangpinzhekou : false,
				shuliang : false,
				shangpinweizhi : false,
				shangpinbeizhu : false,
				clicktime : false,
			},
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='shangpinzhekou'){
							this.ruleForm.shangpinzhekou = obj[o];
							this.ro.shangpinzhekou = true;
							continue;
						}
						if(o=='shuliang'){
						...
						if(o=='shangpinweizhi'){
							this.ruleForm.shangpinweizhi = obj[o];
							this.ro.shangpinweizhi = true;
							continue;
						}
						if(o=='shangpinbeizhu'){
							this.ruleForm.shangpinbeizhu = obj[o];
							this.ro.shangpinbeizhu = true;
							continue;
						}
						if(o=='clicktime'){
				...
				this.ruleForm.shangpinzhekou='1.0'

...
<div :style='{"width":"100%","padding":"40px 7%","margin":"0 auto","position":"relative","background":"none"}'>
	...
	<div class="section-title" :style='{"margin":"10px 0","color":"#000","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230131/c788dee9481d4fd896e419a46388d74e.png) no-repeat center top","fontSize":"20px","lineHeight":"54px","fontWeight":"bold"}'>我的发布</div>
    <el-table
      :data="tableData"
      style="width: 100%">
      <el-table-column
